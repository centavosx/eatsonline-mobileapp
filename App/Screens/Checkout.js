        ...
        {payment.map((payment, index) => (
          ...
          >
            <View
              style={{
                backgroundColor:
                  selectedCategoryIndex == index ? '#eaec31' : '#E5E6A1',
                ...styles.categoryBtn,
              }}
            >
              ...
              <Text
                style={{
                  ...
                  fontWeight: 'bold',
                  marginLeft: 10,
                  color: selectedCategoryIndex == index ? 'black' : 'grey',
                }}
              >
                {payment.name1}
              </Text>
        ...
        {delivery.map((delivery, index) => (
          ...
          >
            <View
              style={{
                backgroundColor:
                  selectedDelivery == index ? '#eaec31' : '#E5E6A1',
                ...styles.categoryBtn,
              }}
            >
              <View style={styles.categoryBtnImgCon}>
              ...
              <Text
                style={{
                  ...
                  fontWeight: 'bold',
                  marginLeft: 10,
                  color: selectedDelivery == index ? 'black' : 'grey',
                }}
              >
                {delivery.name1}
              </Text>
      ...
      >
          ...
          {food.map((food, index) => (
            <View style={{ flexDirection: 'row' }} key={index}>
              ...
              <View style={{ flex: 0.6, alignSelf: 'flex-start' }}>
                <Text style={styles.result} key={food.id}>
                  {food.id}pc of {food.name}{' '}
                </Text>
              </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.result}>
            2 Kalamares S.T. Baranggay Sibuyas Quezon Rizal.
          </Text>
        </View>
        ...
        <View style={{ width: '100%' }}>
          ...
          />
          <PrimaryButton title="PAY" onPress={() => alert(userInput)} />
        </View>
      </ScrollView>
    </SafeAreaView>
  )
